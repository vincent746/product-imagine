        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="page-header">
              <h3 class="page-title">
                <p>Selamat Datang <?php echo $this->session->userdata('logged_in_imagine_admin')->nama_lengkap; echo NOW; ?></p>
              </h3>
            </div>
            ...
            <div class="row">
              <div class="col-md-7 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo base_url('Admin/doChangePassword'); ?>" enctype="multipart/form-data">
                      <div class="form-group">
                        <label for="passwordLama">Password Lama</label>
                        <input type="text" name="old_password" class="form-control" id="passwordLama" placeholder="Password Lama" required>
                      </div>
                      <div class="form-group">
                        <label for="passwordBaru">Password Baru</label>
                        <input type="password" name="new_password" class="form-control" id="passwordBaru" placeholder="Password Baru" required>
                      </div>
                      <div class="form-group">
                      ...
                      <button type="submit" class="btn btn-gradient-primary me-2">Ganti Password</button>
              ...
              <div class="col-md-5 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Change Foto Profile</h4>

                    <img style="margin-bottom: 30px" height="200" width="200" class="rounded-circle mx-auto d-block" src="<?php echo base_url(); ?>/assets/img/avatar/<?php echo $this->session->userdata('logged_in_imagine_admin')->avatar; ?>">
                    <div class="text-center">
                    <form id="formGantiFoto" action="<?php echo base_url('Admin/GantiFoto'); ?>" method="post" enctype="multipart/form-data">
                        <input type="file" id="imgupload" name="avatar" accept="image/png, image/jpeg, image/jpg" />
                    </form>
                    </div>
                  </div>
                </div>
