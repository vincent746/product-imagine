      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          ...
          <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Master Banner Text Slider</h4>
                    <table id="example" class="table table-striped" style="width:100%">
                      ...
                      <tbody>
                        <?php $no_urut = 1; ?>
                            <?php foreach($banner_list as $gaa) { ?>
                          <tr>
                            

                              <td><?php echo $gaa->no_urut; ?></td>
                              <td><?php echo "<img src='" . base_url() . "assets/img/text-slider/" . $gaa->urlbanner . "'>" ?></td>
