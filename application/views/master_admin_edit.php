          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Edit Master Admin</h4>
                    ...
                    <form method="POST" action="<?php echo base_url('Admin/doEdit'); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="nama_lengkap" class="form-control" id="namalengkap" placeholder="Username" value="<?php echo $admin->nama_lengkap; ?>" required>
                        </div>
                        <div class="form-group">
                          <label for="email">Email address</label>
                          <input type="email" name="email" class="form-control" id="email" placeholder="Email" value="<?php echo $admin->email; ?>" required>
                        </div>
                        <div class="form-group">
                          <label for="exampleFormControlSelect2">Status</label>
                          <select class="form-control" name="is_active" id="exampleFormControlSelect2">
                            <option value="1" <?php echo ($admin->is_active == 1 ? 'selected' : ''); ?>>AKTIF</option>
                            <option value="0" <?php echo ($admin->is_active == 0 ? 'selected' : ''); ?>>TIDAK AKTIF</option>
                          </select>
                        </div>
                      <button type="submit" class="btn btn-gradient-primary me-2">Save changes</button>
                       <a href="<?php echo base_url('Admin/Master') ?>"><input type="button" value="Cancel" class="btn btn-light"></button></a>
                    </form>
                  </div>
                </div>
              </div>
