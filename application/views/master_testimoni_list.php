  ...
  <body>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="d-grid gap-2">
              <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#AddMasterAdmin" type="button">+ Add Master Banner Text Slider</button>
            </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                            <?php $no_urut = 1; ?>
                            <?php foreach($testimoni as $gaa) { ?>
                          <tr>
                            

                              <td><?php echo $no_urut; ?></td>
                              <td><?php echo "<img class='img-testimoni' src='" . base_url() . "assets/img/testimonial/" . $gaa->foto . "'>" ?></td>
                              ...
                              <td>Tidak Aktif</td>
                              <?php } ?>
                              <td><?php echo $gaa->nama; ?></td>
                              <td><?php echo $gaa->jabatan; ?></td>
                              <td><?php echo $gaa->keterangan; ?></td>
                              <td><?php echo $gaa->created_at; ?></td>
                              <td><?php echo $gaa->updated_at; ?></td>

                              <?php echo "<td>
                                <a href='" . base_url('MasterBanner/Edit?id=' . $gaa->id) . "'class='btn btn-xs btn-primary'><i class='mdi mdi-table-edit'></i></a>
          ...
          <div class="modal fade" id="AddMasterAdmin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form method="POST" action="<?php echo base_url('MasterBanner/doAdd'); ?>" enctype="multipart/form-data" class="forms-sample">
                  <div class="modal-body">
                        <div class="form-group">
                          <label for="no_urut">Nomor Urut</label>
                          <input type="text" name="no_urut" class="form-control" id="no_urut" placeholder="Nomor Urut" value="<?php echo $banner_list[count($banner_list) - 1]->no_urut + 1; ?>" required>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="input-group col-xs-12">
                            ...
                            <img id="blah" src="#" alt="Image Preview" width="450" />
                          </div>
                        </div>
                  </div>
    ...
    <script type="text/javascript">
      ...
      function DeleteData(id) {
            ...
            if (konfirmasi) {
                window.location.href = "<?php echo base_url('MasterBanner/doDelete?id='); ?>" + id;
            }
        }
