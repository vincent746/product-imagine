...
class MasterBanner extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['banner_list'] = $this->BannerModel->GetAll();

        $this->load->view('master_banner_list', $data);
    }
    ...
    public function Edit()
    {
        ...
        $data['banner'] = $this->BannerModel->Get($id);
